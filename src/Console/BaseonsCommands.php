    ...
    public static function run()
    {
        Console::namespace('Baseons\Console\Commands')->group(function () {
            ...
            Console::title('Http')->prefix('http:')->group(function () {
                Console::command('server {host?} {port?}', 'CommandHttp::server')->description('development server');
            ...
            Console::title('Migrate')->prefix('migrate')->group(function () {
            ...
            Console::title('Clear')->prefix('clear')->group(function () {
